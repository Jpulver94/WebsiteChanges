...
//      menuheight=520 ; 
      alwaysvisible=1 ; 
//      overflow="scroll" ; 
aI("text=Ambulatory Equipment;showmenu=Ambulatory Equipment_1;clickfunction=javascript:browsepath('BRC','001');status=javascript:browsepath('BRC','001');");
aI("text=Apparel;showmenu=Apparel_3;clickfunction=javascript:browsepath('BRC','002');status=javascript:browsepath('BRC','002');");
aI("text=Body Relief & Positioning;showmenu=Body Relief & Positioning_17;clickfunction=javascript:browsepath('BRC','003');status=javascript:browsepath('BRC','003');");
aI("text=Clinical Laboratory;showmenu=Clinical Laboratory_20;clickfunction=javascript:browsepath('BRC','004');status=javascript:browsepath('BRC','004');");
aI("text=Diagnostic;showmenu=Diagnostic_26;clickfunction=javascript:browsepath('BRC','005');status=javascript:browsepath('BRC','005');");
aI("text=Drainage & Suction;showmenu=Drainage & Suction_36;clickfunction=javascript:browsepath('BRC','006');status=javascript:browsepath('BRC','006');");
aI("text=Furnishings;showmenu=Furnishings_43;clickfunction=javascript:browsepath('BRC','008');status=javascript:browsepath('BRC','008');");
aI("text=Gloves;showmenu=Gloves_45;clickfunction=javascript:browsepath('BRC','009');status=javascript:browsepath('BRC','009');");
aI("text=Housekeeping;showmenu=Housekeeping_48;clickfunction=javascript:browsepath('BRC','010');status=javascript:browsepath('BRC','010');");
aI("text=I.v. Therapy;showmenu=I.v. Therapy_55;clickfunction=javascript:browsepath('BRC','011');status=javascript:browsepath('BRC','011');");
aI("text=Incontinence;showmenu=Incontinence_63;clickfunction=javascript:browsepath('BRC','013');status=javascript:browsepath('BRC','013');");
aI("text=Indicators & Signage;showmenu=Indicators & Signage_65;clickfunction=javascript:browsepath('BRC','014');status=javascript:browsepath('BRC','014');");
aI("text=Instruments;showmenu=Instruments_69;clickfunction=javascript:browsepath('BRC','015');status=javascript:browsepath('BRC','015');");
aI("text=Needles & Syringes;showmenu=Needles & Syringes_78;clickfunction=javascript:browsepath('BRC','016');status=javascript:browsepath('BRC','016');");
aI("text=Orthopedic;showmenu=Orthopedic_88;clickfunction=javascript:browsepath('BRC','019');status=javascript:browsepath('BRC','019');");
aI("text=Ostomy;showmenu=Ostomy_91;clickfunction=javascript:browsepath('BRC','020');status=javascript:browsepath('BRC','020');");
aI("text=Over The Counter;showmenu=Over The Counter_93;clickfunction=javascript:browsepath('BRC','021');status=javascript:browsepath('BRC','021');");
aI("text=Personal Hygiene;showmenu=Personal Hygiene_105;clickfunction=javascript:browsepath('BRC','022');status=javascript:browsepath('BRC','022');");
aI("text=Pharmaceuticals;showmenu=Pharmaceuticals_111;clickfunction=javascript:browsepath('BRC','023');status=javascript:browsepath('BRC','023');");
aI("text=Physical Therapy;showmenu=Physical Therapy_115;clickfunction=javascript:browsepath('BRC','024');status=javascript:browsepath('BRC','024');");
aI("text=Respiratory;showmenu=Respiratory_119;clickfunction=javascript:browsepath('BRC','025');status=javascript:browsepath('BRC','025');");
aI("text=Sterilization;showmenu=Sterilization_128;clickfunction=javascript:browsepath('BRC','026');status=javascript:browsepath('BRC','026');");
aI("text=Textiles;showmenu=Textiles_135;clickfunction=javascript:browsepath('BRC','027');status=javascript:browsepath('BRC','027');");
aI("text=Urological;showmenu=Urological_145;clickfunction=javascript:browsepath('BRC','028');status=javascript:browsepath('BRC','028');");
aI("text=Utensils;showmenu=Utensils_148;clickfunction=javascript:browsepath('BRC','029');status=javascript:browsepath('BRC','029');");
aI("text=Wound Care;showmenu=Wound Care_152;clickfunction=javascript:browsepath('BRC','030');status=javascript:browsepath('BRC','030');");
aI("text=Wound Closure;showmenu=Wound Closure_155;clickfunction=javascript:browsepath('BRC','031');status=javascript:browsepath('BRC','031');");
}
